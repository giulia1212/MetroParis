...
class View(ft.UserControl):
    ...
    def load_interface(self):
        ...
        self._btnTrovaPercorso = ft.ElevatedButton(text="Trova Percorso", on_click=self._controller.handleTrovaPercorso)  # ATTENZIONE che NON devo scrivere handleTrovaPercorso()
