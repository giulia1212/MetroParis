...
class Controller:
    ...
    def handleTrovaPercorso(self, e):
        ...
        self._view.lst_result.controls.clear()
        self._view.lst_result.controls.append(ft.Text(f"Ho trovato un cammino fra {self._fermataPartenza} e {self._fermataArrivo} "
    ...
    def handleCreaGrafo(self,e):        # viene chiamato dal pulsante
